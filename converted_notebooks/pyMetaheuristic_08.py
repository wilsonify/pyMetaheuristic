...
# Lesson: pyMetaheuristic - Firefly Algorithm
 
# GitHub Repository: <https://github.com/Valdecy>

# + colab={"base_uri": "https://localhost:8080/"} id="c8YC5nYJtT_h" outputId="c169ec33-e751-4717-c92c-d22e9d80fc29"
# Build Dir
import os
os.chdir('/content')
CODE_DIR = 'code'
...
# FA
from pyMetaheuristic.firefly_algorithm.firefly_a import firefly_algorithm
...
# + colab={"base_uri": "https://localhost:8080/", "height": 846} id="C58gRysEt4B6" outputId="e0073128-7185-4c15-ba83-35db300711a1"
...
# + colab={"base_uri": "https://localhost:8080/"} id="xezrcqUNt98d" outputId="d85e6dae-66f7-4525-df29-76c7b93907ee"
# FA - Algorithm
fa = firefly_algorithm(swarm_size = ss, min_values = minv, max_values = maxv, generations = iter, alpha_0 = alp, beta_0 = bet, gama = gam, target_function = tgt)

# + colab={"base_uri": "https://localhost:8080/"} id="kA6mzXuuuNzj" outputId="670877d7-df56-4343-f3a1-8a349b278300"
# FA - Solution
variables = fa[:-1]
minimum   = fa[ -1]
print('Variables: ', np.around(variables, 4) , ' Minimum Value Found: ', round(minimum, 4) )

# + colab={"base_uri": "https://localhost:8080/", "height": 846} id="KOdloZMguSei" outputId="42156bce-b866-4049-e4fb-966456277ac1"
# FA - Plot Solution
plt.style.use('bmh')
fig = plt.figure(figsize = (15, 15))
ax  = fig.add_subplot(111, projection = '3d')
