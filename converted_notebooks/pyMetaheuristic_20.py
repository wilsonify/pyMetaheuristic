...
# Lesson: pyMetaheuristic - Whale Optimization Algorithm
 
# GitHub Repository: <https://github.com/Valdecy>

# + colab={"base_uri": "https://localhost:8080/"} id="gU6IVStrADtF" outputId="2fb9bce6-0b7c-44f6-8032-7824f8760fe8"
# Build Dir
import os
os.chdir('/content')
CODE_DIR = 'code'
...
# WOA
from pyMetaheuristic.whale_optimization_algorithm.whale_optimization_a import whale_optimization_algorithm
...
# + colab={"base_uri": "https://localhost:8080/", "height": 846} id="56dr3H3UAW3T" outputId="3dfe830f-d487-474a-9b22-3d09464f4648"
...
# + colab={"base_uri": "https://localhost:8080/"} id="yq1A32DIARdH" outputId="b06db5a5-3e2e-4fe9-c778-3ff16c76d4a7"
# WOA - Algorithm
woa = whale_optimization_algorithm(hunting_party = hp, spiral_param = par_m,  min_values = minv, max_values = maxv, iterations = iter, target_function = tgt)

# + colab={"base_uri": "https://localhost:8080/"} id="d4wAxVAsAeac" outputId="a497ce8e-205c-4720-ffaf-fd1eacffd288"
# WOA - Solution
variables = woa[0][:-1]
minimum   = woa[0][ -1]
print('Variables: ', np.around(variables, 4) , ' Minimum Value Found: ', round(minimum, 4) )

# + colab={"base_uri": "https://localhost:8080/", "height": 846} id="o4MwzwqrAg8A" outputId="9efc7eec-9003-4a6f-a99c-712476491e65"
# WOA - Plot Solution
plt.style.use('bmh')
fig = plt.figure(figsize = (15, 15))
ax  = fig.add_subplot(111, projection = '3d')
