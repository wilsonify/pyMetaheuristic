...
# Lesson: pyMetaheuristic - Cuckoo Search 
 
# GitHub Repository: <https://github.com/Valdecy>

# + colab={"base_uri": "https://localhost:8080/"} id="5VKZalMviVb3" outputId="a301d424-216f-496a-bc0d-c250cd232ef2"
# Build Dir
import os
os.chdir('/content')
CODE_DIR = 'code'
...
# CS
from pyMetaheuristic.cuckoo_search.cuckoo_s import cuckoo_search
...
# + colab={"base_uri": "https://localhost:8080/", "height": 846} id="EvSO-sn4illw" outputId="5b6f309f-be03-4a42-8679-da89f2e4331b"
...
# + colab={"base_uri": "https://localhost:8080/"} id="Hsn--ag6it6n" outputId="2a8d1bfd-abaa-4367-ed65-31ac225d9a22"
# CS - Algorithm
cs = cuckoo_search(birds = bd, discovery_rate = dr, alpha_value = av, lambda_value = ld, min_values = minv, max_values = maxv, iterations = iter, target_function = tgt)

# + colab={"base_uri": "https://localhost:8080/"} id="y_3bt5SZi9v5" outputId="cceea0c4-ce7c-422a-85d6-05200297a9f1"
# CS - Solution
variables = cs[:-1]
minimum   = cs[ -1]
print('Variables: ', np.around(variables, 4) , ' Minimum Value Found: ', round(minimum, 4) )

# + colab={"base_uri": "https://localhost:8080/", "height": 846} id="4iCxh3qNjDKE" outputId="25e2d05a-11ab-4794-e3b8-77541055bdb6"
# CS - Plot Solution
plt.style.use('bmh')
fig = plt.figure(figsize = (15, 15))
ax  = fig.add_subplot(111, projection = '3d')
