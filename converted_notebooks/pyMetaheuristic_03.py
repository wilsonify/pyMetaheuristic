...
# Lesson: pyMetaheuristic - Bat Algorithm
 
# GitHub Repository: <https://github.com/Valdecy>

# + colab={"base_uri": "https://localhost:8080/"} id="xaLxguPnclgW" outputId="e1116cff-0950-4bbc-85cd-850675d3c32c"
# Build Dir
import os
os.chdir('/content')
CODE_DIR = 'code'
...
# BA
from pyMetaheuristic.bat_algorithm.bat_a import bat_algorithm
...
# + colab={"base_uri": "https://localhost:8080/", "height": 846} id="YGXmuIJqdm7h" outputId="20dcd17f-d371-47fd-ae46-1df6c50b0b86"
...
# + colab={"base_uri": "https://localhost:8080/"} id="nFQ4aQx5d4l5" outputId="e05fea47-2f7a-454b-f5bc-efe59b9c548a"
# BA - Algorithm
bat = bat_algorithm(swarm_size = ss, min_values = minv, max_values = maxv, iterations = iter, alpha = ap, gama = gm, fmin = fn, fmax = fx, target_function = tgt)

# + colab={"base_uri": "https://localhost:8080/"} id="EWS_oxP9fFbR" outputId="3ab8918f-29e2-42f1-a52c-c94414596ebd"
# BA - Solution
variables = bat[:-1]
minimum   = bat[ -1]
print('Variables: ', np.around(variables, 4) , ' Minimum Value Found: ', round(minimum, 4) )

# + colab={"base_uri": "https://localhost:8080/", "height": 846} id="Ew652ionfPS7" outputId="269c7179-d5d1-4a0d-d3b9-6b8696a08128"
# BA - Plot Solution
plt.style.use('bmh')
fig = plt.figure(figsize = (15, 15))
ax  = fig.add_subplot(111, projection = '3d')
