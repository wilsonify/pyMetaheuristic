...
# Lesson: pyMetaheuristic - Flower Pollination Algorithm
 
# GitHub Repository: <https://github.com/Valdecy>

# + colab={"base_uri": "https://localhost:8080/"} id="t-sWETBzvTms" outputId="038b9e9d-6a87-4cb1-9f74-31922406f49e"
# Build Dir
import os
os.chdir('/content')
CODE_DIR = 'code'
...
# + colab={"base_uri": "https://localhost:8080/", "height": 846} id="8KQOFIaevuhK" outputId="a10ade5d-f3bc-4d20-8d2a-5162f685e21b"
...
# + colab={"base_uri": "https://localhost:8080/"} id="_kCzO8jlviTw" outputId="81e332de-370e-4b34-cad1-962e47855dc6"
# FPA - Algorithm
...
# + colab={"base_uri": "https://localhost:8080/"} id="J08Tk1zgv2WH" outputId="6b45be53-7a98-4415-8df4-75ef16bf70d8"
# FPA - Solution
variables = fpa[:-1]
minimum   = fpa[ -1]
print('Variables: ', np.around(variables, 4) , ' Minimum Value Found: ', round(minimum, 4) )

# + colab={"base_uri": "https://localhost:8080/", "height": 846} id="m9QyByw5v7Gw" outputId="66521e99-c3dc-4713-8d42-9e1225a6d4b5"
# FPA - Plot Solution
plt.style.use('bmh')
fig = plt.figure(figsize = (15, 15))
ax  = fig.add_subplot(111, projection = '3d')
